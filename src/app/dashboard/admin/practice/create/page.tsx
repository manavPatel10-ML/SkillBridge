...
export default function CreatePracticeProblemPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await addDoc(collection(db, "practiceProblems"), {
        ...formData,
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      <div className="flex items-center space-x-4">
        ...
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Create Practice Problem</h1>
          <p className="text-gray-500 text-sm mt-1">Add a new coding challenge for students.</p>
        </div>
      </div>
